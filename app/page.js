        ...
        <header className="w-full py-8 bg-gray-100 shadow-md">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6">
            ...
            <nav className="mt-4 md:mt-0 flex items-center">
              <div  >
                <a target='_blanck' href={"https://github.com/jayavardhan8907"} ><FaGithub className="w-10 h-8"  /></a>
              </div>
            ...
            <div className="flex flex-wrap justify-center mt-8">
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">-Rishith</h4>
                </div>
              </div>
              <div className="w-full md:w-1/2 px-4 py-8">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  ...
                  <h4 className="mt-4 text-lg font-semibold text-blue-600">- Srinivas</h4>
                </div>
              </div>
            </div>
          </div>
